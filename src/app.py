...
player_data = pd.read_csv('https://raw.githubusercontent.com/naveen-chalasani/nba-analytics-heroku-app/main/data/players_stats_by_season_full_details.csv', usecols = lambda x: x not in columns_to_skip)
